...
% Last Mod: 09/03/14 by Don Hagler
%
...
...
  ...
  'order12_labels_thickness',{'motorpremotor.sma','medialprefrontal','ventralfrontal',...
    'middletemporal','perisylvian','ventromedialoccipital','medialtemporal',...
    'inferiorparietal','temporalpole','dorsolateralprefrontal',...
    'superiorparietal','occipital'},[],...
});

fuzzy_names = cell(1,parms.fuzzy_order);
switch parms.measname
    case {'area','thickness'}
        switch parms.fuzzy_order
            case {2,4,12}
                fuzzy_labels = parms.(sprintf('order%d_labels_%s',parms.fuzzy_order,parms.measname));
